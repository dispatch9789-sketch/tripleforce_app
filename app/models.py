...
class PricingSettings(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, default=1)
    # Base rates
    base_charge = db.Column(db.Float, default=35.00)
    per_mile_charge = db.Column(db.Float, default=2.00)
    minimum_charge = db.Column(db.Float, default=35.00)
    loaded_miles_included = db.Column(db.Float, default=10.00)
    loaded_mile_charge = db.Column(db.Float, default=2.00)
    deadhead_miles_included = db.Column(db.Float, default=10.00)
    deadhead_mile_charge = db.Column(db.Float, default=1.25)

    # Surcharges (flat amounts)
    rush_charge = db.Column(db.Float, default=25.00)
    stat_charge = db.Column(db.Float, default=35.00)
    same_day_charge = db.Column(db.Float, default=10.00)
    after_hours_charge = db.Column(db.Float, default=20.00)
    weekend_charge = db.Column(db.Float, default=30.00)
    holiday_charge = db.Column(db.Float, default=0.00)
    sunday_holiday_customer_quote = db.Column(db.Boolean, default=True)
    wait_time_included_minutes = db.Column(db.Float, default=15.00)
    wait_time_block_minutes = db.Column(db.Float, default=15.00)
    wait_time_per_block = db.Column(db.Float, default=20.00)
    additional_stop_charge = db.Column(db.Float, default=15.00)
